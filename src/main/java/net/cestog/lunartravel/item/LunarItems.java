...
public class LunarItems {
    ...
    public static final DeferredItem<Item> DESH_SWORD = ITEMS.registerItem("desh_sword",
            props -> new Item(
                    props.sword(
                            ToolMaterial.COPPER, // Je kunt dit later vervangen door je eigen LUNAR/DESH_MATERIAL
    ...
    public static final DeferredItem<Item> SPACE_SUIT_HELMET = ITEMS.registerItem("space_suit_helmet",
            props -> new Item(
                    props.humanoidArmor(
                            ArmorMaterials.COPPER, // Je kunt dit later vervangen door je eigen SPACE_SUIT_MATERIAL
                            ArmorType.HELMET
                    )
            ));
